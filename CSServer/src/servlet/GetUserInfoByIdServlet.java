...
import dao.GetUserByIdResponse;
import dao.UserDaoServiceStub;
import entity.xsd.User;
import net.sf.json.JSONArray;

/**
 * Servlet implementation class GetUserInfoByIdServlet
 */
@WebServlet(urlPatterns="/GetUserInfoById", name="GetUserInfoById")
public class GetUserInfoByIdServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			GetUserById para = new GetUserById();
			GetUserByIdResponse resp;
			
			para.setUserId(userId);
			resp = stub.getUserById(para);
